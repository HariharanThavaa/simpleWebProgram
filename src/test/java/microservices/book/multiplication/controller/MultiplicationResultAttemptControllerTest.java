...
public class MultiplicationResultAttemptControllerTest {
    ...
    public void postResultReturnCorrect() throws Exception {
        genericPrameterizedTest(true);
    }

    @Test
    public void postResultReturnNotCorrect() throws Exception {
        genericPrameterizedTest(false);
    }

    void genericPrameterizedTest(final boolean correct) throws Exception {
        // given
        given(multiplicationService.checkAttempt(any(MultiplicationResultAttempt.class))).willReturn(correct);

        User user = new User("Hariharan");
        Multiplication multiplication = new Multiplication(70, 30);
        MultiplicationResultAttempt resultAttempt = new MultiplicationResultAttempt(user, multiplication, 2100, false);
    ...
    public void getUserStats() throws Exception {
        ...
        given(multiplicationService.getStatsForUser("Hariharan")).willReturn(recentAttempts);

        // when
        MockHttpServletResponse response = mvc.perform(get("/results").param("alias", "Hariharan"))
                .andReturn().getResponse();
